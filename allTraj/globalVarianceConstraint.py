...
def loadData(mean, sigma, gvMean, gvSigma):
    statics = {}
    ...
    statics['gvMean'] = gvMean
    statics['gvSigma'] = gvSigma
     
    return statics     

def calcTrajectory(statics,lOpt):
    l = lOpt
...
if __name__ == "__main__":
    ...
    trajectory = calcTrajectory(statics, lOpt)
